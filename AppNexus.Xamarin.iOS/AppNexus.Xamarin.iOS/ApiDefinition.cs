...
namespace AppNexus.Xamarin.iOS
{
    ...
    interface IANLocation
    {
        ...
        IANLocation GetLocationWithLatitude(nfloat latitude, nfloat longitude, NSDate timestamp, nfloat horizontalAccuracy);
        ...
        IANLocation GetLocationWithLatitude(nfloat latitude, nfloat longitude, NSDate timestamp, nfloat horizontalAccuracy, nint precision);
    }

    // @protocol ANAdProtocolFoundation <NSObject>
    [Protocol, Model]
    [BaseType(typeof(NSObject))]
    interface IANAdProtocolFoundation
    {
    ...
    [Protocol, Model]
    interface IANAdProtocolBrowser
    {
    ...
    [Protocol, Model]
    interface IANAdProtocolPublicServiceAnnouncement
    {
    ...
    [Protocol, Model]
    interface IANAdProtocol : IANAdProtocolFoundation, IANAdProtocolBrowser, IANAdProtocolPublicServiceAnnouncement
    {
    ...
    [Protocol, Model]
    interface IANNativeAdRequestProtocol : IANAdProtocolFoundation
    {
    }

    // @protocol ANNativeAdResponseProtocol <ANAdProtocolBrowser>
    [Protocol, Model]
    interface IANNativeAdResponseProtocol : IANAdProtocolBrowser
    {
    }

    // @protocol ANVideoAdProtocol <ANAdProtocol, ANAdProtocolVideo>
    [Protocol, Model]
    interface IANVideoAdProtocol : IANAdProtocol, IANAdProtocolVideo
    {
    }
    ...
    interface IANAdView : IANAdProtocol
    {
    }
    ...
    [BaseType(typeof(NSObject))]
    interface IANNativeAdStarRating
    {
    ...
    [BaseType(typeof(NSObject))]
    interface IANNativeAdResponse : IANNativeAdResponseProtocol
    {
        ...
        IANNativeAdStarRating Rating { get; }
    ...
    [BaseType(typeof(NSObject))]
    interface IANNativeAdRequest : IANNativeAdRequestProtocol
    {
    ...
    interface IANNativeAdRequestDelegate
    {
        ...
        void DidReceiveResponse(IANNativeAdRequest request, IANNativeAdResponse response);
        ...
        void DidFailToLoadWithError(IANNativeAdRequest request, NSError error);
    }

    // @interface ANBannerAdView : ANAdView
    [BaseType(typeof(IANAdView))]
    interface IANBannerAdView
    {
        [Wrap("WeakDelegate")]
        IANBannerAdViewDelegate Delegate { get; set; }
        ...
        IANBannerAdView AdViewWithFrame(CGRect frame, string placementId);
        ...
        IANBannerAdView AdViewWithFrame(CGRect frame, string placementId, CGSize size);
    ...
    [Protocol, Model]
    interface IANBannerAdViewDelegate : IANAdDelegate
    {
    }

    // @interface ANTargetingParameters : NSObject
    [BaseType(typeof(NSObject))]
    interface IANTargetingParameters
    {
    ...
    interface IANCustomAdapterInterstitial : IANCustomAdapter
    {
        ...
        void RequestInterstitialAdWithParameter(string parameterString, string idString, IANTargetingParameters targetingParameters);
    ...
    [Protocol, Model]
    [BaseType(typeof(NSObject))]
    interface IANInstreamVideoAdLoadDelegate
    {
    ...
    [Protocol, Model]
    [BaseType(typeof(NSObject))]
    interface IANInstreamVideoAdPlayDelegate
    {
        ...
        [Export("adWasClicked:withURL:")]
        void AdWasClicked(IANAdProtocol ad, string urlString);
        ...
        void AdPlayStarted(IANAdProtocol ad);
    }

    // @interface ANInstreamVideoAd : ANAdView <ANVideoAdProtocol>
    [BaseType(typeof(IANAdView))]
    interface IANInstreamVideoAd : IANVideoAdProtocol
    {
        [Wrap("WeakLoadDelegate")]
        IANInstreamVideoAdLoadDelegate LoadDelegate { get; }
        ...
        IANInstreamVideoAdPlayDelegate PlayDelegate { get; }
        ...
        bool LoadAdWithDelegate(IANInstreamVideoAdLoadDelegate loadDelegate);
        ...
        void PlayAdWithContainer(UIView adContainer, IANInstreamVideoAdPlayDelegate playDelegate);
    ...
    [Protocol, Model]
    interface IANInterstitialAdDelegate : IANAdDelegate
    {
        // @optional -(void)adFailedToDisplay:(ANInterstitialAd *)ad;
        [Export("adFailedToDisplay:")]
        void AdFailedToDisplay(IANInterstitialAd ad);
    }

    // @interface ANLogManager : NSObject
    [BaseType(typeof(NSObject))]
    interface IANLogManager
    {
    ...
    [BaseType(typeof(IANNativeAdResponse))]
    interface IANNativeMediatedAdResponse
    {
        ...
        [Export("rating", ArgumentSemantic.Strong)]
        IANNativeAdStarRating Rating { get; set; }
    ...
    interface IANNativeCustomAdapter
    {
        ...
        void RequestNativeAdWithServerParameter(string parameterString, string adUnitId, IANTargetingParameters targetingParameters);
    ...
    interface IANNativeCustomAdapterRequestDelegate
    {
        ...
        void DidLoadNativeAd(IANNativeMediatedAdResponse response);
    ...
    partial interface Constants
    {
        ...
        IntPtr AppNexusSDKVersionString { get; }
    }
